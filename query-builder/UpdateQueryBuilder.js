...
var UpdateQueryBuilder = /** @class */ (function (_super) {
     ...
     */
    UpdateQueryBuilder.prototype.execute = function (userLogin) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        queryRunner.broadcaster.broadcastBeforeUpdateEvent(broadcastResult, this.expressionMap.mainAlias.metadata, undefined, undefined, undefined, undefined, userLogin);
                    ...
                    case 8:
                        ...
                        broadcastResult = new BroadcasterResult_1.BroadcasterResult();
                        queryRunner.broadcaster.broadcastAfterUpdateEvent(broadcastResult, this.expressionMap.mainAlias.metadata, undefined, undefined, undefined, undefined, userLogin);
                    ...
                    case 20:
                        if (!(this.connection.driver instanceof SqljsDriver_1.SqljsDriver &&
                            !queryRunner.isTransactionActive)) return [3 /*break*/, 22];
    ...
    UpdateQueryBuilder.prototype.createUpdateExpression = function () {
        ...
        var metadata = this.expressionMap.mainAlias.hasMetadata
        ...
        if (metadata) {
            EntityMetadata_1.EntityMetadata.createPropertyPath(metadata, valuesSet).forEach(function (propertyPath) {
                ...
                columns.forEach(function (column) {
                    ...
                    if (value instanceof Function) {
                        ...
                        updateColumnAndValues.push(_this.escape(column.databaseName) +
                            " = " +
                            value());
                    }
                    else {
                        if (_this.connection.driver instanceof
                            SqlServerDriver_1.SqlServerDriver) {
                        ...
                        var expression = null;
                        if (_this.connection.driver instanceof MysqlDriver_1.MysqlDriver &&
                            _this.connection.driver.spatialTypes.indexOf(column.type) !== -1) {
                            expression = "GeomFromText(" + _this.connection.driver.createParameter(paramName, parametersCount) + ")";
                        }
                        else if (_this.connection.driver instanceof
            ...
            Object.keys(valuesSet).map(function (key) {
                ...
                if (value instanceof Function) {
                    ...
                    updateColumnAndValues.push(_this.escape(key) +
                        " = " +
                        _this.connection.driver.createParameter(key, parametersCount));
                    parametersCount++;
                }
            });
        }
