...
var SubjectExecutor = /** @class */ (function () {
    ...
    SubjectExecutor.prototype.broadcastAfterEventsForAll = function (userLogin) {
        ...
        if (this.removeSubjects.length)
            this.removeSubjects.forEach(function (subject) { return _this.queryRunner.broadcaster.broadcastAfterRemoveEvent(result, subject.metadata, subject.entity || subject.identifier, subject.databaseEntity, undefined, userLogin); });
        return result;
    };
    /**
                                                    ...
                                                    return tslib_1.__generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            ...
                                                            case 3:
                                                                ...
                                                                return [4 /*yield*/, new ClosureSubjectExecutor(this.queryRunner).insert(subject, userLogin)];
                                                            case 4:
                                                                _a.sent();
                                                                return [3 /*break*/, 7];
                                                            case 5:
                                                                if (!(subject.metadata.treeType === "materialized-path")) return [3 /*break*/, 7];
                                                                return [4 /*yield*/, new MaterializedPathSubjectExecutor(this.queryRunner).insert(subject, userLogin)];
                                                            case 6:
                                                                _a.sent();
                                                                _a.label = 7;
