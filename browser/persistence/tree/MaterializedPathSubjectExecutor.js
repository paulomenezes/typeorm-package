...
var MaterializedPathSubjectExecutor = /** @class */ (function () {
     ...
     */
    MaterializedPathSubjectExecutor.prototype.insert = function (subject, userLogin) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        insertedEntityId = subject.metadata
                            .treeParentRelation.joinColumns.map(function (joinColumn) {
