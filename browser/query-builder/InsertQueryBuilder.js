...
var InsertQueryBuilder = /** @class */ (function (_super) {
     ...
     */
    InsertQueryBuilder.prototype.execute = function (userLogin) {
                ...
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        valueSets.forEach(function (valueSet) {
                            queryRunner.broadcaster.broadcastBeforeInsertEvent(broadcastResult_1, _this.expressionMap.mainAlias.metadata, valueSet, userLogin);
                        });
                    ...
                    case 8:
                        ...
                        valueSets.forEach(function (valueSet) {
                            queryRunner.broadcaster.broadcastAfterInsertEvent(broadcastResult_2, _this.expressionMap.mainAlias.metadata, valueSet, userLogin);
                        });
